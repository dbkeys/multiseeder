...
{
    memcpy(cfg_message_start, ::cfg_message_start[TempMainThreadNumber], sizeof(cfg_message_start));
...
{
    // Check start string
    if (memcmp(cfg_message_start, ::cfg_message_start[TempMainThreadNumber], sizeof(cfg_message_start)) != 0)
        return false;
