...
bool TestNode(int _TempMainThreadNumber, const CService &cip, int &ban, int &client, std::string &clientSV, int &blocks, bool &insync, std::vector<CAddress>* vAddr, uint64_t& services);
